...
type SortBy = 'price_asc' | 'price_desc' | 'alarm_count';

export const discoverApi = {
  categories: () =>
    client.get<CategoryResponse[]>(ENDPOINTS.DISCOVER_CATEGORIES),

  categoryProducts: (slug: string, page = 1, sort_by: SortBy = 'alarm_count') =>
    client.get<ProductResponse[]>(ENDPOINTS.DISCOVER_CATEGORY_PRODUCTS(slug), {
